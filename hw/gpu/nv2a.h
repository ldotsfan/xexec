...
#define NV2A_MASK_BITSHIFT_SET(x,y,z) \
        NV2A_MASK_SET((x), y ## _ ## z << y ## __BITSHIFT)
...
#define NV2A_BLOCK(x,y,z) \
    ...
    NV2A_BLOCK(PRMA,        0x007000, 0x001000),    /*  4 */    /* no implementation */
    NV2A_BLOCK(PVIDEO,      0x008000, 0x001000),    /*  5 */
    NV2A_BLOCK(PTIMER,      0x009000, 0x001000),    /*  6 */
    NV2A_BLOCK(PCOUNTER,    0x00a000, 0x001000),    /*  7 */    /* no implementation */
    NV2A_BLOCK(PVPE,        0x00b000, 0x001000),    /*  8 */    /* no implementation */
    NV2A_BLOCK(PTV,         0x00d000, 0x001000),    /*  9 */    /* no implementation */
    NV2A_BLOCK(PRMFB,       0x0a0000, 0x020000),    /* 10 */    /* no implementation */
    NV2A_BLOCK(PRMVIO,      0x0c0000, 0x001000),    /* 11 */    /* no implementation */
    NV2A_BLOCK(PFB,         0x100000, 0x001000),    /* 12 */
    NV2A_BLOCK(PSTRAPS,     0x101000, 0x001000),    /* 13 */    /* no implementation */
    ...
    NV2A_BLOCK(PRMCIO,      0x601000, 0x001000),    /* 18 */    /* no implementation */
    NV2A_BLOCK(PRAMDAC,     0x680000, 0x001000),    /* 19 */
    NV2A_BLOCK(PRMDIO,      0x681000, 0x001000),    /* 20 */    /* no implementation */
...
#define COLOR1(a,b,c,d,e,f) \
        COLOR2(a,b,c,d,e,f,0,0,0,0)
#define COLOR2(a,b,c,d,e,f,g,h,i,j) \
...
#define COLOR(a,b,c,d,e) \
        [NV_097_SET_SURFACE_FORMAT_COLOR_ ## a] = { #a, b, c, d, e }
...
static const nv2a_pgraph_surface_format const nv2a_pgraph_context_surfaces_formats[] = {
#define COLOR(a,b,c,d,e) \
        [NV_062_COLOR_FORMAT_ ## a] = { #a, b, c, d, e }
    /*  1 */ // LE_Y8
